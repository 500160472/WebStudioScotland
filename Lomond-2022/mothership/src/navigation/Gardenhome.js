...
export default class Gardenhome extends React.Component {
  ...
  pickPageToRender = () => {
    ...
    if (this.state.page === 3) {
        return (<ProductGuarantee pageChange={(pageNum) => this.setState({page: pageNum})} lead={this.state.lead}  setClose={() => this.setState({closeStatus1: !this.state.closeStatus1})} closeStatus={this.state.closeStatus1}/>);
      }
