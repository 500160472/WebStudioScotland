...
<ScrollView style={{width: '100%', paddingTop: 76}}>
    ...
    <View style={{backgroundColor: '#fff',flex:2, height: 300, borderRadius: 12, justifyContent: 'center', alignContent: 'center', padding: 40,}}>
      <Text style={{textAlign: 'center'}}>CHOSEN WINDOW INFORMATION</Text>
